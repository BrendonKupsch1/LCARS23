...
(function (TSOS) {
    class Shell {
        ...
        init() {
            ...
            this.commandList[this.commandList.length] = sc;
            // runall
            sc = new TSOS.ShellCommand(this.shellRunAll, "runall", "- Runs all processes in the ready queue.");
            this.commandList[this.commandList.length] = sc;
            // ps
            sc = new TSOS.ShellCommand(this.shellPs, "ps", "- Lists all running processes and their IDs.");
            this.commandList[this.commandList.length] = sc;
            // kill
            sc = new TSOS.ShellCommand(this.shellKill, "kill", "<pid> - Kills the process with the specified pid.");
            this.commandList[this.commandList.length] = sc;
            // killall
            ...
            this.commandList[this.commandList.length] = sc;
            // copy
            sc = new TSOS.ShellCommand(this.shellCopy, "copy", "<filename> <newfilename> - Copies a file.");
            this.commandList[this.commandList.length] = sc;
            // rename
            sc = new TSOS.ShellCommand(this.shellRename, "rename", "<filename> <newfilename> - Renames a file.");
            this.commandList[this.commandList.length] = sc;
            // ls
